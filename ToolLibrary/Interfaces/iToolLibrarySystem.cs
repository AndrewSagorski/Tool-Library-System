...
namespace ToolLibrary
{
    public interface iToolLibrarySystem
    {
        ...
        void displayBorrowingTools(Member aMember); // given a member, display all the tools that the
                                                     // member are currently renting
        ...
        void displayTopThree(); // Display top three most frequently borrowed tools by the members in
                                // the descending order by the number of times each tool has been borrowed.
    }
}
